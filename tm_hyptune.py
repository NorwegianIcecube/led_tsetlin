...
enc = TMAutoEncoder(number_of_clauses=clauses, T=t,
                    s=s, output_active=output_active, accumulation=accumulation, feature_negation=False, platform='CPU', output_balancing=True)
